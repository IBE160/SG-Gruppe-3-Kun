...
| 2025-12-13 | 4.3 | 4 | TechDebt | Low | TBD | Open | Consider establishing a comprehensive E2E testing framework (e.g., Playwright) for the frontend to cover user interaction flows like clicking suggested queries. |
| 2025-12-13 | 2.4 | 2 | Bug | High | TBD | Open | Create integration test for frontend API route (`frontend/app/api/chat/route.ts`) to verify proxy logic. AC #1, #2. |
| 2025-12-13 | 2.4 | 2 | Bug | High | TBD | Open | Create E2E test (e.g., Playwright) to verify the full chat flow and real-time updates. AC #4. |